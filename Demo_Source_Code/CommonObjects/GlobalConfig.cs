...
namespace EaseFilter.CommonObjects
{
    ...
    {      
        ...
        static string accountName = "Sachin Jegaonkar";
        static string masterPassword = "testpassword";
        static string licenseKey = "11542-941E5-86503-C186E-C8EC0-63A09-0BB1F-142"; // This is a registration key for the trial license key - 11542-941E5-86503-C186E-CBEC0-66A50
        ...
        static string protectFolder = "C:\\Testing\\EaseFilter\\protectFolder";
        static string protectFolderWhiteList = "*";
        static string protectFolderBlackList = "explorer.exe";
        static string shareFolder = "C:\\Testing\\EaseFilter\\shareFolder";
        static string shareFolderWhiteList = "notepad.exe;wordpad.exe";
        static string shareFolderBlackList = "explorer.exe";
        static string drInfoFolder = "C:\\Testing\\EaseFilter\\DRInfoFolder";
        static string dropFolder = "C:\\Testing\\EaseFilter\\dropFolder";

...
namespace FileProtector
{
    public partial class FileProtectorUnitTest : Form
    {
        ...
        /// </summary>
        private static string unitTestFolder = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest";
        private static string unitTestFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\unitTestFile.txt";

        /// <summary>
        /// Test monitor feature with registering the IO events, get notification after the file was closed for the registered IO.
        /// </summary>
        private static string unitTestMonitorTestFolder = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\monitorFolder";
        private static string unitTestMonitorTestFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\monitorFolder\\unitTestMonitorTestFile.txt";
        ...
        /// </summary>
        private static string unitTestCallbackFolder = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\callbackFolder";
        private static string unitTestCallbackFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\callbackFolder\\unitTestFile.txt";
        ...
        private static string unitTestCallbackDeletionPreventionFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\callbackFolder\\deletionPreventionInCallbackUnitTestFile.txt";
        private static string unitTestCopyAfterDeleteCallbackFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\callbackFolder\\unitTestCopyAfterDeleteCallbackFile.txt";
        ...
        /// </summary>
        private static string filterRuleExcludeTestFolder = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\excludeFolder";
        private static string excludeFolderTestFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\excludeFolder\\excludeFile.txt";
        ...
        /// </summary>
        private static string globalExcludeFilterRuleTestFolder = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\excludeFilterRuleFolder";
        private static string globalExcludeFilterRuleTestFile = "C:\\Testing\\EaseFilter\\EaseFilterUnitTest\\excludeFilterRuleFolder\\excludeFilterRuleTestFile.txt";
        ...
        private void FolderProtectionUnitTest()
        {
            ...
            //All files in the test folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest" will be readonly, except the current process, you can add more authorized processes here.   
            //All files in the test folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest" can't be accessed by process "explorer.exe" and "cmd.exe", you can add more processes.
        ...
        private void AddProcessRightsUnitTest()
        {
            ...
            //Test folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest" .   
        ...
        private void AddUserRightsUnitTest()
        {
            ...
            //Set current user with readonly right access to folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest".   
        ...
        private void NoRenameAndCopyUnitTest()
        {
            ...
            //All files with protected extension ".prt" only can store in protected folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest".   
            //
        ...
        private void FolderLockerUnitTest()
        {
            ...
            //1. Transparently encrypt/decrpt files files in the test folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest".   
            //2. All files are hidden in the test folder "C:\\Testing\\EaseFilter\\EaseFilterUnitTest".
